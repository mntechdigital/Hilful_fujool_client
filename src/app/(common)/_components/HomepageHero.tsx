...
const HomepageHero = async () => {
  ...
  return (
    <div className="relative min-h-[calc(100vh-20%)] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[calc(80vh-80px)]">
        {/* Left Content */}
        ...
        <div className="flex flex-wrap gap-4 pt-4">
          <Link
          href="/hajj-packages"
          className="group flex items-center gap-2 bg-yellow-500 hover:bg-yellow-600 text-slate-900 font-semibold px-8 py-4 rounded-full transition-all duration-300 shadow-lg hover:shadow-yellow-500/50"
          >
          Explore Packages
          ...
          className="flex items-center gap-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white font-semibold px-8 py-4 rounded-full transition-all duration-300 border border-white/20"
          >
