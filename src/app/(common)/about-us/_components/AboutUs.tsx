            ...
            <div className="">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="md:col-span-1 flex flex-col justify-between">
                        <div className="flex flex-col gap-4 bg-[#F8F8F8] rounded-xl p-5 shadow-sm h-full justify-between">
                            ...
                            <Link href="/services" className="mt-3 md:mt-0 px-6 py-2 bg-yellow-600 text-white rounded-full font-semibold flex items-center gap-2 hover:bg-yellow-700 transition">
                                All Services
                            </Link>
                        </div>
                    </div>
